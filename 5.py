# Develop a program to implement k-Nearest Neighbour algorithm
# to classify the randomly generated 100 values of x in the range of [0,1]. Perform the following based on dataset generated.
...
for k in k_values:
    ...
    for i, label in enumerate(classified_labels):
        print(f"Point x{i+51} (value: {test_data[i]:.4f}) is classified as {label}")
    print("\n")
...
for k in k_values:
    ...
    plt.scatter(
        train_data, 
        [0] * len(train_data), # y coordinates should be zero
